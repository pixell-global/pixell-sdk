...
class PXUIDataClient:
    ...
    async def get_brand_context(self) -> Optional[dict[str, Any]]:
        ...
        and formats it for use in agent context, including any
        accumulated research intelligence.
        ...
        Returns:
            ...
            - industry: str | None
            - website: str | None
            - competitors: list[str]  (name-only for backward compat)
            - competitor_details: list[dict]  (enriched with research data)
        ...
        return {
            ...
            # Backward-compatible name-only list
            "competitors": [c["competitor_name"] for c in competitors],
            # Enriched competitor details with research data
            "competitor_details": [
                {
                    "id": c["id"],
                    "name": c["competitor_name"],
                    "website": c.get("competitor_website"),
                    "research_data": c.get("research_data"),
    ...
    async def save_competitor_research(
        self,
        brand_id: str,
        competitor_id: str,
        research_data: dict[str, Any],
    ) -> dict[str, Any]:
        """Save research intelligence for a competitor.

        Persists research results (analysis, strategy, strengths/weaknesses)
        generated by agents so they accumulate over time.

        Args:
            brand_id: The brand ID
            competitor_id: The competitor ID to update
            research_data: Research intelligence dict from agent analysis

        Returns:
            Updated competitor record
        ...
        return await self._request(
            "PATCH",
            f"/api/v1/brands/{brand_id}/competitors/{competitor_id}/research",
